...
This is a beginner project in Phaser with Vite and Typescript. Full contents from README generated by running `npm create @phaserjs/game@latest` included below.
