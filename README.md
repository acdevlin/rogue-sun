...
This is a beginner project in Phaser with Vite and Typescript. 

Running: `npm run dev`

Testing: `npm run test` (uses vitest behind-the-scenes)

Full contents from README generated by running `npm create @phaserjs/game@latest` included below.
